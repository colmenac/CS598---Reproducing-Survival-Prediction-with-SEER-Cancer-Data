...
<<<<<<< HEAD
“This repository is based on code originally written by Hegselmann, S., Jutzeler, C. R., & Buecheler, M. (2018). Reproducible survival prediction with SEER cancer data. Machine Learning for Healthcare Conference.![image](https://github.com/user-attachments/assets/0b4a1d21-9990-438f-a22d-9f355441272f)
. Modifications were made as part of my project/paper for academic purposes.”


=======
>>>>>>> a2d4d3c8 (Fixed embedded repo issue with FinalProject folder)
Repository overview:
